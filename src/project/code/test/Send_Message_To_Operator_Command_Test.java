...
public class Send_Message_To_Operator_Command_Test {
	...
	public void Constructor_Normal_Test() {
		...
		Command command = new Send_Message_To_Operator_Command(new String("Unit 1"), "Message Command test");
	...
	public void Constructor_NormalStringLiteral_Test() {
		...
		Command command = new Send_Message_To_Operator_Command("Unit 2", "Message Command test");
		assertNotNull("Command object should have been instantiated.", command);
		assertEquals("Should be priority 1.", command.Priority(), 1);
	}
	...
	public void Constructor_NullUnitID_Test() {
		...
		try {
			command = new Send_Message_To_Operator_Command(null, "Message Command test");
		} catch (Throwable e) {
	...
	public void Constructor_EmptyStringUnitID_Test() {
		...
		Command command = null;
		try {
			command = new Send_Message_To_Operator_Command(new String(), "Message Command test");
		} catch (Throwable e) {
			assertTrue("Should have thrown a Null_Unit_ID_Exception",
					e instanceof Null_Unit_ID_Exception);
			thrown = true;
	...
	public void Constructor_EmptyStringLiteralUnitID_Test() {
		...
		Command command = null;
		try {
			command = new Send_Message_To_Operator_Command("", "Message Command test");
		} catch (Throwable e) {
			assertTrue("Should have thrown a Null_Unit_ID_Exception",
					e instanceof Null_Unit_ID_Exception);
			thrown = true;
	...
	public void Constructor_UnitIDNotPresent_Test() {
		...
		Command command = null;
		try {
			command = new Send_Message_To_Operator_Command("Unit 3", "Message Command test");
		} catch (Throwable e) {
			assertTrue("Should have thrown a Null_Unit_ID_Exception",
					e instanceof Null_Unit_ID_Exception);
			thrown = true;
	...
	public void Execute_Test() {
		...
		Command command = null;
		try {
			command = new Send_Message_To_Operator_Command("Unit 4", "Message Command test (K-10), this should print!");
			assertNotNull("Instance should have been successfully created.", command);
			command.Execute();
		} catch (Null_Unit_ID_Exception e) {
			fail("Should not have thrown exception");
		}
		//TODO: automate validation here: for now check stdout for message.
	}
	 ...
	 */
	@Test
	public void Execute_ResponseUnitNotPresent_Test() {
		boolean thrown = false;
		Command command = null;
		try {
			command = new Send_Message_To_Operator_Command("Unit 5", "Message Command test (K-11), this shouldn't print");
			command.Execute();
		} catch (Throwable e) {
			assertTrue("Should have thrown a Null_Unit_ID_Exception",
					e instanceof Null_Unit_ID_Exception);
	...
	public void PriorityAccessors_Test() {
		...
		Command command = new Send_Message_To_Operator_Command("Unit 6", "Message Command test");
		assertEquals("Should be priority 1.", command.Priority(), 1);
	...
	public void SetPriorityToNull_Test() {
		...
		boolean thrown = false;
		Command command = new Send_Message_To_Operator_Command("Unit 7", "Message Command test");
		try {
	...
	public void SetPriorityToInvalid_Test() {
		...
		boolean thrown = false;
		Command command = new Send_Message_To_Operator_Command("Unit 8", "Message Command test");
		try {
	...
	public void UnitIDSet_Test() {
		...
		Command command = new Send_Message_To_Operator_Command("Unit 9", "Message Command test");
	...
	public void Constructor_SetUnitIDToNull_Test() {
		...
		boolean thrown = false;
		Command command = new Send_Message_To_Operator_Command("Unit 10", "Message Command test");
		try {
	...
	public void SetUnitIDToEmptyString_Test() {
		...
		boolean thrown = false;
		Command command = new Send_Message_To_Operator_Command("Unit 11", "Message Command test");
		try {
	...
	public void SetUnitIDToEmptyStringLiteral_Test() {
		...
		boolean thrown = false;
		Command command = new Send_Message_To_Operator_Command("Unit 12", "Message Command test");
		try {
			command.Set_Unit_ID("");
		} catch (Throwable e) {
			assertTrue("Should have thrown a Null_Unit_ID_Exception",
